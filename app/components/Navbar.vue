<template>
  ...
  -->
        ...
        <ActionItem v-if="hasBack" @tap="$navigateBack"
                    ios.position="right"
                    android:visibility="collpase">
            <button class="fa" text.decode="&#xf054;"/>
        </ActionItem>


        <ActionItem v-else @tap="onDrawerButtonTap"
                    ios.position="right"
                    android:visibility="collpase">
            <button class="fa" text.decode="&#xf0c9;"/>
        </ActionItem>
        ...
        methods: {
            ...
            createEvent() {
                ...
                if (!this.user) {
                    ...
                    this.$showModal(this.$routes.CreateEvent, { fullscreen: true})
                }
